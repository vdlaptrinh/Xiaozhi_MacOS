...
class CliDisplay(BaseDisplay):
    ...
    def _redraw_input_line(self, content: str) -> None:
        ...
        prompt = "enter: " if not self._use_ansi else "\x1b[1m\x1b[36m输入:\x1b[0m "
    ...
    async def _render_dashboard(self, full: bool = False):
        ...
        lines = [
            f"state: {trunc(self._dash_status)}",
            f"connect: {'Connected' if self._dash_connected else 'Not connected'}",
