            ...
            ColumnLayout {
                ...
                Rectangle {
                    ...
                    Text {
                        anchors.fill: parent
                        anchors.margins: 10
                        text: displayModel ? displayModel.ttsText : "stand by"
                        font.family: "PingFang SC, Microsoft YaHei UI"
                        font.pixelSize: 13
                        color: "#555555"
                        horizontalAlignment: Text.AlignHCenter
        ...
        Rectangle {
            ...
            RowLayout {
                ...
                Button {
                    ...
                    onReleased: { manualBtn.text = "Press and hold to speak"; root.manualButtonReleased() }
                }
                ...
                Button {
                    ...
                    Layout.preferredHeight: 38
                    text: "interrupting the conversation"
                ...
                Button {
                    ...
                    Layout.maximumWidth: 120
                    Layout.preferredHeight: 38
                    text: displayModel ? displayModel.modeText : "Manual dialogue"
