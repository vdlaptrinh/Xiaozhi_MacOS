...
class GuiDisplayModel(QObject):
    ...
    def __init__(self, parent=None):
        ...
        self._tts_text = "Stand by"
        self._button_text = "Start conversation"  # 自动模式按钮文本
        self._mode_text = "Manual dialogue"  # 模式切换按钮文本
    ...
    def update_status(self, status: str, connected: bool):
        ...
        更新状态文本和连接状态.
        """
        self.statusText = f"State: {status}"
    ...
    def set_auto_mode(self, is_auto: bool):
        ...
        if is_auto:
            self.modeText = "Automatic dialogue"
        else:
            self.modeText = "Manual dialogue"
