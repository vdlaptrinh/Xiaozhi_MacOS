...
class SystemTray(QObject):
    ...
    def _create_tray_menu(self):
        ...
        # 添加显示主窗口菜单项
        show_action = QAction("Display main window", self.parent_widget)
        ...
        # 添加停止音乐菜单项
        self.stop_music_action = QAction("Stop Music", self.parent_widget)
        self.stop_music_action.triggered.connect(self._on_stop_music)
        self.tray_menu.addAction(self.stop_music_action)
